...
//! CRC16_CCITT standard, polygon code 0x1021
...
const uint8_t activates[] = {
  ACTIVATION, 0x01
};
const uint8_t frequency[] = {
  ACTIVATION, 0x10
};
const uint8_t toMobile[] = {
  ACTIVATION, 0xFE
};
const uint8_t broadcast[] = {
  BROADCAST, 0x00
};
const uint8_t lostCTRL[] = {
  BROADCAST, 0x01
};
const uint8_t fromMobile[] = {
  BROADCAST, 0x02
};
...
const uint8_t setArm[] = {
  CONTROL, 0x05
};
const uint8_t killSwitch[] = {
  CONTROL, 0x06
};
const uint8_t cameraShot[] = {
  CONTROL, 0x20
};
const uint8_t cameraVideoStart[] ={ 
	CONTROL, 0x21 
};
const uint8_t cameraVideoStop[] = {
  CONTROL, 0x22
};
const uint8_t gimbalSpeed[] = {
  CONTROL, 0x1A
};
const uint8_t gimbalAngle[] = {
  CONTROL, 0x1B
};
const uint8_t waypointInit[] = {
  MISSION, 0x10
};
const uint8_t waypointAddPoint[] ={ 
	MISSION, 0x11 
};
const uint8_t waypointSetStart[] ={ 
	MISSION, 0x12 
};
const uint8_t waypointSetPause[] = { 
  MISSION, 0x13 
};
const uint8_t waypointDownload[] = { 
	MISSION, 0x14 
};
const uint8_t waypointIndexDownload[] = {
  MISSION, 0x15
};
const uint8_t waypointSetVelocity[] = {
  MISSION, 0x16
};
const uint8_t waypointGetVelocity[] = {
  MISSION, 0x17
};
const uint8_t hotpointStart[] = {
  MISSION, 0x20
};
const uint8_t hotpointStop[] = {
  MISSION, 0x21
};
const uint8_t hotpointSetPause[] = { 
	MISSION, 0x22 
};
const uint8_t hotpointYawRate[] = {
  MISSION, 0x23
};
const uint8_t hotpointRadius[] = {
  MISSION, 0x24
};
const uint8_t hotpointSetYaw[] = {
  MISSION, 0x25
};
const uint8_t hotpointDownload[] ={ 
	MISSION, 0x26 
};
const uint8_t followStart[] = {
  MISSION, 0x30
};
const uint8_t followStop[] = {
  MISSION, 0x31
};
const uint8_t followSetPause[] = {
  MISSION, 0x32
};
const uint8_t followTarget[] = {
  MISSION, 0x33
};
const uint8_t ha_broadcast[] = {
  HARDWARE_SYNC, 0x00
};
...
const uint8_t versionMatch[] = {
  SUBSCRIBE, 0x00
};
const uint8_t addPackage[] = {
  SUBSCRIBE, 0x01
};
const uint8_t reset[] = {
  SUBSCRIBE, 0x02
};
const uint8_t removePackage[] = {
  SUBSCRIBE, 0x03
};
const uint8_t updatePackageFreq[] = {
   SUBSCRIBE, 0x04
};
const uint8_t pauseResume[] = {
  SUBSCRIBE, 0x05
};
const uint8_t getConfig[] = {
  SUBSCRIBE, 0x06
};
